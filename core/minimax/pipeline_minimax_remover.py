# ──────────────────────────────────────────────────────────────────────────────
# Vendored from: https://github.com/zibojia/MiniMax-Remover
# File:          pipeline_minimax_remover.py
...
#   - Changed Transformer3DModel import to relative import from this package
#   - Replaced hardcoded "cuda:0" with self._execution_device for multi-GPU
#     and CPU-offload compatibility
# ──────────────────────────────────────────────────────────────────────────────
