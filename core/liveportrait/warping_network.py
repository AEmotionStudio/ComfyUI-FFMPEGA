# coding: utf-8
"""Warping Network (W) for LivePortrait.

Generates a warping field using implicit keypoint representations
and warps the source feature volume accordingly.
"""
...
class WarpingNetwork(nn.Module):
    def __init__(self, num_kp, block_expansion, max_features,
                 num_down_blocks, reshape_channel,
                 estimate_occlusion_map=False,
                 dense_motion_params=None, **kwargs):
        super().__init__()
        ...
        self.third = SameBlock2d(
            ...
            kernel_size=(3, 3), padding=(1, 1), lrelu=True,
        )
