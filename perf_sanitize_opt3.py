...
def sanitize_text_param_re(text: str) -> str:
    ...
    return ESCAPE_RE.sub(lambda m: "%%" if m.group(1) == "%" else "\\\\" + m.group(1), text)
...
print("RE Clean string:", timeit.timeit(stmt_clean_re, setup=setup, number=100000))
print("RE Dirty string:", timeit.timeit(stmt_dirty_re, setup=setup, number=100000))
