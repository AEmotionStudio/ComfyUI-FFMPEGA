# FFMPEGA Skill Test Prompts

Copy & paste these directly into the FFMPEGA node to test each skill.
...
### saturation
```
Boost the saturation to make colors more vibrant
```

### hue
```
Shift the hue toward blue/teal
```
...
### blur
```
Apply a soft blur with radius 10
```

### denoise
```
Remove noise and grain from the video
```
...
### colorbalance
```
Make the shadows warmer and add blue to midtones
```
...
### text_overlay
```
Add the text 'Hello World' in yellow at the bottom
```
...
### edge_detect
```
Apply edge detection to make it look like a sketch
```

### pixelate
```
Pixelate the video like an 8-bit game
```

### gamma
```
Adjust gamma to brighten the midtones
```
...
### pitch
```
Pitch the audio up by 2 semitones
```
...
### stereo_swap
```
Swap the left and right stereo channels
```
...
### audio_speed
```
Speed up only the audio to 1.5x
```

### chorus
```
Add a chorus effect to thicken the sound
```
...
### lowpass
```
Muffle the audio with a low pass filter
```

### highpass
```
Remove the bass rumble with a high pass filter
```
...
### compress_audio
```
Compress the audio dynamics to even out volume
```
...
### convert
```
Convert to H.265 codec
```

### quality
```
Set quality to high with CRF 18
```
...
### audio_codec
```
Set audio codec to AAC at 192k bitrate
```
...
### cinematic
```
Apply a cinematic Hollywood film look
```

### blockbuster
```
Give it a Michael Bay blockbuster style
```

### documentary
```
Apply a clean documentary look
```

### indie_film
```
Give it an indie art-house film aesthetic
```

### commercial
```
Make it look like a bright corporate commercial
```

### dream_sequence
```
Apply a dreamy ethereal dream sequence look
```

### action
```
Give it an action movie grading
```

### romantic
```
Apply a soft warm romantic mood
```

### sci_fi
```
Give it a cool blue sci-fi atmosphere
```
...
### vintage
```
Apply a vintage old film look
```

### vhs
```
Make it look like a VHS tape recording
```
...
### super8
```
Give it a Super 8mm film look
```

### polaroid
```
Apply a Polaroid instant photo aesthetic
```

### faded
```
Give it a washed-out faded look
```

### old_tv
```
Make it look like an old CRT television
```

### damaged_film
```
Make it look like aged damaged film
```

### noir
```
Apply a film noir black and white style
```
...
### social_vertical
```
Make it vertical 9:16 for TikTok
```

### social_square
```
Make it square 1:1 for Instagram
```
...
### twitter
```
Optimize for Twitter/X posting
```
...
### caption_space
```
Add blank space at the bottom for captions
```
...
### horror
```
Give it a horror movie atmosphere
```

### underwater
```
Make it look like underwater footage
```

### sunset
```
Apply a golden hour sunset glow
```

### cyberpunk
```
Give it a cyberpunk neon aesthetic
```
...
### surveillance
```
Make it look like security camera footage
```

### music_video
```
Give it a music video look with punchy colors
```

### anime
```
Apply an anime cel-shaded style
```

### lofi
```
Give it a lo-fi chill aesthetic
```
...
### posterize
```
Posterize to reduce the color palette
```
...
### mirror
```
Apply a mirror kaleidoscope effect
```

### slow_zoom
```
Add a slow push-in zoom
```
